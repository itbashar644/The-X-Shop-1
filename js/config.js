...
const CONFIG = {
  ...
  telegramBotToken: 'your_telegram_bot_token', // Будет заменен на реальный токен в production
  telegramChatId: 'your_telegram_chat_id' // Будет заменен на реальный ID чата в production
};
